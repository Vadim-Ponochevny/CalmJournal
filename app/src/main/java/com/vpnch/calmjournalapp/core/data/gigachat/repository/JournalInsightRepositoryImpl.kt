package com.vpnch.calmjournalapp.core.data.gigachat.repository

import com.vpnch.calmjournalapp.core.data.gigachat.local.GigaChatPreferences
import com.vpnch.calmjournalapp.core.data.gigachat.network.dto.ChatCompletionRequest
import com.vpnch.calmjournalapp.core.data.gigachat.network.dto.ChatMessage
...
import com.vpnch.calmjournalapp.core.domain.repository.JournalInsightRepository
...
class JournalInsightRepositoryImpl @Inject constructor(
    ...
    override suspend fun analyzeJournalEntry(text: String): JournalInsightResult<String> {
        ...
        val request = ChatCompletionRequest(
            model = "GigaChat",
            messages = listOf(
                ChatMessage(role = "system", content = cbtSystemPromptRu),
